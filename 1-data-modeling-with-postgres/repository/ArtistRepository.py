...
from model.sql_queries import artist_table
import os
...
class ArtistRepository():
    def __init__(self, logger: Logger):
        ...
        self.table_name: str = artist_table["table_name"]
        self.fields: List[str] = artist_table["fields"]
        self.keys: List[str] = artist_table["keys"]
