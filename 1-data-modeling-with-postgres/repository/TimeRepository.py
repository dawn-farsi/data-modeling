...
from model.sql_queries import time_table
import os
...
class TimeRepository():
    def __init__(self, logger: Logger):
        ...
        self.table_name: str = time_table["table_name"]
        self.fields: List[str] = time_table["fields"]
        self.keys: List[str] = time_table["keys"]
