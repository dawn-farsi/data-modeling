...
from model.sql_queries import user_table
import os
...
class UserRepository():
    def __init__(self, logger: Logger):
        ...
        self.table_name: str = user_table["table_name"]
        self.fields: List[str] = user_table["fields"]
        self.keys: List[str] = user_table["keys"]
