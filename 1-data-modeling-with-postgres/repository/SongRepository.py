...
from model.sql_queries import song_table
import os
...
class SongRepository():
    def __init__(self, logger: Logger):
        ...
        self.table_name: str = song_table["table_name"]
        self.fields: List[str] = song_table["fields"]
        self.keys: List[str] = song_table["keys"]
